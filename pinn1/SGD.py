...
class ThermalCond(nn.Module):
    def __init__(self):
        ...
        # Задаем архитектуру: 3 скрытых слоя по 20 нейронов с функцией активации ReLu
        self.layers = nn.Sequential(
            nn.Linear(2, 50), # На вход x и t
            nn.ReLU(),
            nn.Linear(50, 50),
            nn.ReLU(),
            nn.Linear(50, 50), # PReLU тоже неплох*
            nn.ReLU(),
            nn.Linear(50, 1)) # На выходе U(x,t)
...
# График зависимости Loss от Epochs
